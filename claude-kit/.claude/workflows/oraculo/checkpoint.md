...
<completion_guidance>
Note: Inline checkpoint now runs automatically at the end of each `oraculo:exec` wave. Use this command for re-validation after manual fixes or when the inline checkpoint recommends it.
