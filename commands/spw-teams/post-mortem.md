...
@.claude/workflows/spw/overlays/teams/post-mortem.md
</execution_context>

<process>
Follow the base workflow from `@.claude/workflows/spw/post-mortem.md` end-to-end.
Then apply the teams overlay from `@.claude/workflows/spw/overlays/teams/post-mortem.md` as additional policy.
