...
- Traceability judge report: `.spec-workflow/specs/claude-code-based-improvements/execution/waves/wave-02/checkpoint/run-002/traceability-judge/report.md`

## Config Context
 from spw-config.toml by dispatch-setup<!-- Auto-resolved -->
- tdd_default: off
- max_wave_size: 3
...
- Report: .spec-workflow/specs/claude-code-based-improvements/execution/waves/wave-02/checkpoint/run-002/release-gate-decider/report.md
- Status: .spec-workflow/specs/claude-code-based-improvements/execution/waves/wave-02/checkpoint/run-002/release-gate-decider/status.json
